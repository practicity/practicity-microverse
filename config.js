...
export const FOG_MODE               = 3; // corresponds to BABYLON.Scene.FOGMODE_LINEAR
...
export const CAMERA_HEIGHT              = 0.175;   // eye level in world units
export const CAMERA_LOOK_AHEAD          = 10;
export const CAMERA_MIN_Z               = 0.1;    // near clip
export const CAMERA_SPEED               = 0.15;   // was 0.60, slower for CELL_SIZE=1 world
...
export const INTERACTION_MAX_DISTANCE   = 40;    // world units
export const INTERACTION_KEY     = "E";      // what the user sees
export const INTERACTION_KEY_CODE = "KeyE";  // physical key position
